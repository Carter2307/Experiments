...
import FullScreenCraft from "@/components/templates/FullScreenCraft.tempalte";
...
const Section2 = ({scrollYProgress}: { scrollYProgress: MotionValue }) => {
    ...
    return (<motion.div className="sticky top-0  h-screen" style={{scale, rotate}}>
